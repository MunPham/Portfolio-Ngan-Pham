          ...
          <div className="w-full max-w-[1800px] flex flex-col gap-12 md:gap-[80px]">
            ...
            <div className="flex w-full justify-center items-center overflow-visible relative">
              <div className="flex -space-x-8 md:-space-x-12 px-6 md:px-12 items-center justify-center translate-x-4 md:translate-x-6">
                {[
                  { src: "/Generated Image April 08, 2026 - 3_32AM.png", title: "Key Visuals", rotation: -6, yOffset: 20 },
                  { src: "/Generated Image April 08, 2026 - 3_33AM.png", title: "Social Media Design", rotation: 8, yOffset: -30 },
                  { src: "/Generated Image April 08, 2026 - 3_38AM.png", title: "Presentation Design", rotation: -4, yOffset: 40 },
                  { src: "/LỊCH VISA 2026/THÁNG 1.webp", title: "Merchandise", rotation: 10, yOffset: -10 },
                  { src: "/Generated Image April 08, 2026 - 3_34AM.png", title: "Brand Identity", rotation: -8, yOffset: 10 }
                ].map((p, i) => (
